			...
			<div id="content-div" class="row">
				...
				<div class="col-md-9 text-content-style">
							...
							<p>La Oficina General de Recursos Humanos es el órgano de apoyo,
								...
								de planificar, normar y ejecutar los procesos técnicos en
								materia de gestión del recurso humano de la Institución.</p>
							...
							<ul>
								...
								<li><p>Proponer a la Alta Dirección las normas, planes,
										programas y acciones para la gestión del Sistema de Recursos
										Humanos.</p></li>
								...
								<li><p>Fomentar una actitud proactiva en los servidores
										docentes, administrativos y obreros y desarrollo del liderazgo
										de los directivos de la Universidad a través de acciones
										sostenidas de mejoramiento de su calidad personal y
										profesional.</p></li>
								...
								<li><p>Promover el desarrollo personal, social y laboral así
										como la capacitación técnica de los servidores, orientados al
										logro de las metas y objetivos institucionales, en función de
										las necesidades de la entidad y los resultados de la
										evaluación de desempeño.</p></li>
								...
								<li><p>Mantener actualizado el archivo de Legajos de servidores
										y ex servidores docentes, administrativos y obreros de la
										Universidad.</p></li>
								<li><p>Elaborar la Planilla Única de Remuneraciones y de
										...
										cumplan labores efectivas, así como consignar los conceptos
										que legalmente correspondan abonarse.</p></li>
								<li><p>Establecer estrategias para aprovechar los conocimientos
										y experiencia de ex servidores docentes, administrativos y
							...
							<p>En esta sección Usted podra encontrar información referente a
								la Oficina General de Recursos Humanos de la Universidad
								Nacional Mayor de San Marcos; dentro de lo más relevante se
								tiene:</p>
							<ul>
