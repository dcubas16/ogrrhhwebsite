<div class="left-navbar col-md-3 left-navbar-background-style" data-bind="visible: pageId() == 1">
	<div class="row">
		<div class="col-md-11">
...
<div class="left-navbar col-md-3 left-navbar-background-style" data-bind="visible: pageId() == 2">
...
<div class="left-navbar col-md-3 left-navbar-background-style" data-bind="visible: pageId() == 3">
	<div class="bs-docs-sidebar hidden-print affix-top vertical-navbar"
		role="complementary">
		<ul class="nav bs-docs-sidenav">
			<li class=""
				data-bind="attr: { class: (<?php echo $sub_page_id?> == 1)? 'active' : '' }"><a
				class="vertical-navbar-font-style" href="offices-gestion.php">Oficina de Gestión y Escalafón</a></li>
			<li class=""
				data-bind="attr: { class: (<?php echo $sub_page_id?> == 2)? 'active' : '' }"><a
				class="vertical-navbar-font-style" href="offices-remuneration.php">Oficina de Remuneraciones y Obligaciones Sociales</a></li>
			<li class=""
				data-bind="attr: { class: (<?php echo $sub_page_id?> == 3)? 'active' : '' }"><a
				class="vertical-navbar-font-style"
				href="offices-pension.php">Oficina de Pensiones y Beneficios Sociales</a></li>
			<li class=""
				data-bind="attr: { class: (<?php echo $sub_page_id?> == 4)? 'active' : '' }"><a
				class="vertical-navbar-font-style" href="offices-development.php">Oficina de Desarrollo y Bienestar Social</a></li>
		</ul>
		<a class="back-to-top" href="#top">Retornar al inicio</a>
	</div>
</div>
<div class="left-navbar col-md-3 left-navbar-background-style" data-bind="visible: pageId() == 4">
	<div class="bs-docs-sidebar hidden-print affix-top vertical-navbar"
		role="complementary">
		<ul class="nav bs-docs-sidenav">
			<li class=""
				data-bind="attr: { class: (<?php echo $sub_page_id?> == 1)? 'active' : '' }"><a
				class="vertical-navbar-font-style" href="legislation-resolutions.php">Resoluciones Emitidas</a></li>
			<li class=""
				data-bind="attr: { class: (<?php echo $sub_page_id?> == 2)? 'active' : '' }"><a
				class="vertical-navbar-font-style" href="legislation-laws.php">Leyes y Decretos</a></li>
			<li class=""
				data-bind="attr: { class: (<?php echo $sub_page_id?> == 3)? 'active' : '' }"><a
				class="vertical-navbar-font-style"
				href="legislation-directives.php">Directivas</a></li>
			<li class=""
				data-bind="attr: { class: (<?php echo $sub_page_id?> == 4)? 'active' : '' }"><a
				class="vertical-navbar-font-style" href="legislation-ogrrhh-legislation.php">Normatividad OGRRHH y UNMSM</a></li>
		</ul>
		<a class="back-to-top" href="#top">Retornar al inicio</a>
	</div>
</div>
<div class="left-navbar col-md-3 left-navbar-background-style" data-bind="visible: pageId() == 5">
	<div class="bs-docs-sidebar hidden-print affix-top vertical-navbar"
		role="complementary">
		<ul class="nav bs-docs-sidenav">
			<li class=""
