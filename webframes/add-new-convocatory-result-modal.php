<div class="modal fade" id="add-new-convocatory-result-modal" tabindex="-1"
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel">Agregar Nuevo Resultado de Convocatoria</h4>
			</div>
			<form id="addNewConvocatoryResult" method="post" class="form-horizontal"
				enctype="multipart/form-data" action="upload-convocatory-FTP.php">
				<div class="modal-body">
					<div class="form-group">
						<label class="col-md-3 control-label">Tipo</label>
						<div class="col-md-9 selectContainer">
							<select name="convocatory_result_type_id" id="convocatory_result_type_id"
								class="form-control" data-bind="value: convocatoryResultTypeId">
								<option value="">Resultado Preliminar</option>
								<option value="1">Resultado Final</option>
							</select>
						</div>
					</div>
...
var convocatoryResultViewModel = {
		convocatoryResultTypeId : ko.observable(null),
		fileToUpload : 	ko.observable(null)
};

$(document).ready(function() {
	ko.applyBindings(convocatoryResultViewModel, $("#add-new-convocatory-result-modal")[0]);
...
// 	    });
    ...
    $('#addNewConvocatoryResult').bootstrapValidator({
        feedbackIcons: {
...
$('#add-new-convocatory-result-modal').on('hidden.bs.modal', function (e) {
	...
	$("#addNewConvocatoryResult").data('bootstrapValidator').resetForm();
})

function onChange(){
// 	$("#addNewConvocatoryResult").data('bootstrapValidator')
